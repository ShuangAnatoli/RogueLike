...
player = Actor(
    ...
    ai_cls=HostileEnemy,
    equipment=Equipment(),
    fighter=Fighter(hp=300000, base_defense=1, base_power=2, base_attack=3, base_armor = 10),
...
orc = Actor(
    ...
    ai_cls=HostileEnemy,
    equipment=Equipment(),
    fighter=Fighter(hp=10, base_defense=0, base_power=3, base_attack=2, base_armor = 13),
...
troll = Actor(
    ...
    ai_cls=HostileEnemy,
    equipment=Equipment(),
    fighter=Fighter(hp=16, base_defense=1, base_power=4, base_attack=1, base_armor=15),
    inventory=Inventory(capacity=0),
